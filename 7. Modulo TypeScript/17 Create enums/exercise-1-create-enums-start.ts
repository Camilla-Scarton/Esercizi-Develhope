...
enum Currency {
    Euro, // = "Euro" to make a string enum instead of a numeric enum
    Dollar, // = "Dollar" to make a string enum instead of a numeric enum
}
...
const countryLanguages: { language: string; status: LanguageStatus }[] = [
