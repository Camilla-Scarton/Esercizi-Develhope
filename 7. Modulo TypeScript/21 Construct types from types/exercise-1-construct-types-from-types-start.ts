...
const countryB: CompleteCountry = {
    ...
    code: "GR",
    languages: ["Greek"],
    currency: "Euro",        // with Required all properties are mapped as required 
...
// countryC.population = 60_317_117; <- removed because all properties mapped are set as readonly 
